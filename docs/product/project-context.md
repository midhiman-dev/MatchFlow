...
**MatchFlow is a challenge-scoped MVP built to demonstrate real fan and operator value in large cricket venues through real-time crowd intelligence, queue-aware guidance, and safety-first routing.**
