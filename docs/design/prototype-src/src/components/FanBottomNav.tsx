...
export const FanBottomNav: React.FC<FanBottomNavProps> = ({ activeTab, onTabChange }) => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white/80 backdrop-blur-xl border-t border-outline-variant/10 px-4 pb-8 pt-2 flex justify-around items-center shadow-[0_-8px_32px_rgba(11,25,60,0.06)]">
